...
#define __HAL_RCC_DMA1_CLK_ENABLE()                 sim_nop()
#define __HAL_RCC_DMA2_CLK_ENABLE()                 sim_nop()
#define __HAL_RCC_DMAMUX1_CLK_ENABLE()              sim_nop()
#define __HAL_RCC_CRC_CLK_ENABLE()                  sim_nop()

#define __HAL_RCC_DMA1_CLK_DISABLE()                sim_nop()
#define __HAL_RCC_DMA2_CLK_DISABLE()                sim_nop()
#define __HAL_RCC_DMAMUX1_CLK_DISABLE()             sim_nop()
#define __HAL_RCC_CRC_CLK_DISABLE()                 sim_nop()


#define __HAL_RCC_GPIOA_CLK_ENABLE()           sim_nop()
#define __HAL_RCC_GPIOB_CLK_ENABLE()           sim_nop()
#define __HAL_RCC_GPIOC_CLK_ENABLE()           sim_nop()
#define __HAL_RCC_GPIOH_CLK_ENABLE()           sim_nop()

#define __HAL_RCC_GPIOA_CLK_DISABLE()          sim_nop()
#define __HAL_RCC_GPIOB_CLK_DISABLE()          sim_nop()
#define __HAL_RCC_GPIOC_CLK_DISABLE()          sim_nop()
#define __HAL_RCC_GPIOH_CLK_DISABLE()          sim_nop()

#define __HAL_RCC_PKA_CLK_ENABLE()                sim_nop()
#define __HAL_RCC_AES_CLK_ENABLE()                sim_nop()
#define __HAL_RCC_RNG_CLK_ENABLE()                sim_nop()
#define __HAL_RCC_HSEM_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_IPCC_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_FLASH_CLK_ENABLE()              sim_nop()

#define __HAL_RCC_PKA_CLK_DISABLE()               sim_nop()
#define __HAL_RCC_AES_CLK_DISABLE()               sim_nop()
#define __HAL_RCC_RNG_CLK_DISABLE()               sim_nop()
#define __HAL_RCC_HSEM_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_IPCC_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_FLASH_CLK_DISABLE()             sim_nop()

#define __HAL_RCC_TIM2_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_RTCAPB_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_SPI2_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_USART2_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_I2C1_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_I2C2_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_I2C3_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_DAC_CLK_ENABLE()                sim_nop()
#define __HAL_RCC_LPTIM1_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_LPTIM3_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_LPUART1_CLK_ENABLE()            sim_nop()
#define __HAL_RCC_LPTIM2_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_TIM2_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_RTCAPB_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_SPI2_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_USART2_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_I2C1_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_I2C2_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_I2C3_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_DAC_CLK_DISABLE()               sim_nop()
#define __HAL_RCC_LPTIM1_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_LPTIM2_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_LPTIM3_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_LPUART1_CLK_DISABLE()           sim_nop()

#define __HAL_RCC_WWDG_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_WWDG_CLK_DISABLE()              sim_nop()

#define __HAL_RCC_ADC_CLK_ENABLE()                sim_nop()
#define __HAL_RCC_TIM1_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_SPI1_CLK_ENABLE()               sim_nop()
#define __HAL_RCC_USART1_CLK_ENABLE()             sim_nop()
#define __HAL_RCC_TIM16_CLK_ENABLE()              sim_nop()
#define __HAL_RCC_TIM17_CLK_ENABLE()              sim_nop()

#define __HAL_RCC_ADC_CLK_DISABLE()               sim_nop()
#define __HAL_RCC_TIM1_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_SPI1_CLK_DISABLE()              sim_nop()
#define __HAL_RCC_USART1_CLK_DISABLE()            sim_nop()
#define __HAL_RCC_TIM16_CLK_DISABLE()             sim_nop()
#define __HAL_RCC_TIM17_CLK_DISABLE()             sim_nop()

#define __HAL_RCC_SUBGHZSPI_CLK_ENABLE()          sim_nop()
#define __HAL_RCC_SUBGHZSPI_CLK_DISABLE()         sim_nop()

#define __HAL_RCC_SUBGHZ_CLK_ENABLE()             sim_stm32_hal_rcc_subghz_clk_enable()
#define __HAL_RCC_SUBGHZ_CLK_DISABLE()            sim_stm32_hal_rcc_subghz_clk_disable()

#define __HAL_RCC_DMA1_IS_CLK_ENABLED()           sim_nop()
#define __HAL_RCC_DMA2_IS_CLK_ENABLED()           sim_nop()
#define __HAL_RCC_DMAMUX1_IS_CLK_ENABLED()        sim_nop()
#define __HAL_RCC_CRC_IS_CLK_ENABLED()            sim_nop()

#define __HAL_RCC_GPIOA_IS_CLK_ENABLED()          sim_nop()
#define __HAL_RCC_GPIOB_IS_CLK_ENABLED()          sim_nop()
#define __HAL_RCC_GPIOC_IS_CLK_ENABLED()          sim_nop()
#define __HAL_RCC_GPIOH_IS_CLK_ENABLED()          sim_nop()

#define __HAL_RCC_PKA_IS_CLK_ENABLED()            sim_nop()
#define __HAL_RCC_AES_IS_CLK_ENABLED()            sim_nop()
#define __HAL_RCC_RNG_IS_CLK_ENABLED()            sim_nop()
#define __HAL_RCC_HSEM_IS_CLK_ENABLED()           sim_nop()
#define __HAL_RCC_IPCC_IS_CLK_ENABLED()           sim_nop()
#define __HAL_RCC_FLASH_IS_CLK_ENABLED()          sim_nop()

#define __HAL_RCC_TIM2_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_TIM2) 
#define __HAL_RCC_RTCAPB_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_RTCAPB) 
#define __HAL_RCC_SPI2_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_SPI2) 
#define __HAL_RCC_USART2_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_USART2) 
#define __HAL_RCC_I2C1_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_I2C1) 
#define __HAL_RCC_I2C2_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_I2C2) 
#define __HAL_RCC_I2C3_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_I2C3) 
#define __HAL_RCC_DAC_IS_CLK_ENABLED()            sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_DAC) 
#define __HAL_RCC_LPTIM1_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP1_PERIPH_LPTIM1) 

#define __HAL_RCC_LPTIM2_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP2_PERIPH_LPTIM2) 
#define __HAL_RCC_LPTIM3_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP2_PERIPH_LPTIM3) 
#define __HAL_RCC_LPUART1_IS_CLK_ENABLED()        sim_stm32_hal_clk_enabled(LL_C2_APB1_GRP2_PERIPH_LPUART1)

#define __HAL_RCC_WWDG_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_APB1_GRP1_PERIPH_WWDG) 

#define __HAL_RCC_ADC_IS_CLK_ENABLED()            sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_ADC)   
#define __HAL_RCC_TIM1_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_TIM1)  
#define __HAL_RCC_SPI1_IS_CLK_ENABLED()           sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_SPI1)  
#define __HAL_RCC_USART1_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_IS_CLK_ENABLED()          sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_TIM16) 
#define __HAL_RCC_TIM17_IS_CLK_ENABLED()          sim_stm32_hal_clk_enabled(LL_C2_APB2_GRP1_PERIPH_TIM17) 

#define __HAL_RCC_SUBGHZSPI_IS_CLK_ENABLED()      sim_stm32_hal_clk_enabled(LL_APB3_GRP1_PERIPH_SUBGHZSPI)
#define __HAL_RCC_SUBGHZ_IS_CLK_ENABLED()         sim_stm32_hal_clk_enabled(LL_APB3_GRP1_PERIPH_SUBGHZSPI)

#define __HAL_RCC_AHB1_FORCE_RESET()              sim_nop()
#define __HAL_RCC_DMA1_FORCE_RESET()              sim_nop()
#define __HAL_RCC_DMA2_FORCE_RESET()              sim_nop()
#define __HAL_RCC_DMAMUX1_FORCE_RESET()           sim_nop()
#define __HAL_RCC_CRC_FORCE_RESET()               sim_nop()

#define __HAL_RCC_AHB1_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_DMA1_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_DMA2_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_DMAMUX1_RELEASE_RESET()         sim_nop()
#define __HAL_RCC_CRC_RELEASE_RESET()             sim_nop()
/**
  * @}
  */
...
/** @defgroup RCC_AHB2_Force_Release_Reset AHB2 Peripheral Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_AHB2_FORCE_RESET()              sim_nop()
#define __HAL_RCC_GPIOA_FORCE_RESET()             sim_nop()
#define __HAL_RCC_GPIOB_FORCE_RESET()             sim_nop()
#define __HAL_RCC_GPIOC_FORCE_RESET()             sim_nop()
#define __HAL_RCC_GPIOH_FORCE_RESET()             sim_nop()

#define __HAL_RCC_AHB2_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_GPIOA_RELEASE_RESET()           sim_nop()
#define __HAL_RCC_GPIOB_RELEASE_RESET()           sim_nop()
#define __HAL_RCC_GPIOC_RELEASE_RESET()           sim_nop()
#define __HAL_RCC_GPIOH_RELEASE_RESET()           sim_nop()

#define __HAL_RCC_IPCC_FORCE_RESET()              sim_nop()
#define __HAL_RCC_IPCC_RELEASE_RESET()            sim_nop()

#define __HAL_RCC_AHB3_FORCE_RESET()              sim_nop()
#define __HAL_RCC_PKA_FORCE_RESET()               sim_nop()
#define __HAL_RCC_AES_FORCE_RESET()               sim_nop()
#define __HAL_RCC_RNG_FORCE_RESET()               sim_nop()
#define __HAL_RCC_HSEM_FORCE_RESET()              sim_nop()
#define __HAL_RCC_FLASH_FORCE_RESET()             sim_nop()

#define __HAL_RCC_AHB3_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_PKA_RELEASE_RESET()             sim_nop()
#define __HAL_RCC_AES_RELEASE_RESET()             sim_nop()
#define __HAL_RCC_RNG_RELEASE_RESET()             sim_nop()
#define __HAL_RCC_HSEM_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_FLASH_RELEASE_RESET()           sim_nop()

#define __HAL_RCC_APB1L_FORCE_RESET()             sim_nop()
#define __HAL_RCC_TIM2_FORCE_RESET()              sim_nop()
#define __HAL_RCC_SPI2_FORCE_RESET()              sim_nop()
#define __HAL_RCC_USART2_FORCE_RESET()            sim_nop()
#define __HAL_RCC_I2C1_FORCE_RESET()              sim_nop()
#define __HAL_RCC_I2C2_FORCE_RESET()              sim_nop()
#define __HAL_RCC_I2C3_FORCE_RESET()              sim_nop()
#define __HAL_RCC_DAC_FORCE_RESET()               sim_nop()
#define __HAL_RCC_LPTIM1_FORCE_RESET()            sim_nop()

#define __HAL_RCC_APB1H_FORCE_RESET()             sim_nop()
#define __HAL_RCC_LPUART1_FORCE_RESET()           sim_nop()
#define __HAL_RCC_LPTIM2_FORCE_RESET()            sim_nop()
#define __HAL_RCC_LPTIM3_FORCE_RESET()            sim_nop()
...
#define __HAL_RCC_APB1L_RELEASE_RESET()           sim_nop()
#define __HAL_RCC_TIM2_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_USART2_RELEASE_RESET()          sim_nop()
#define __HAL_RCC_SPI2_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_I2C1_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_I2C2_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_I2C3_RELEASE_RESET()            sim_nop()
#define __HAL_RCC_DAC_RELEASE_RESET()             sim_nop()
#define __HAL_RCC_LPTIM1_RELEASE_RESET()          sim_nop()

#define __HAL_RCC_APB1H_RELEASE_RESET()           sim_nop()
#define __HAL_RCC_LPUART1_RELEASE_RESET()         sim_nop()
#define __HAL_RCC_LPTIM2_RELEASE_RESET()          sim_nop()
#define __HAL_RCC_LPTIM3_RELEASE_RESET()          sim_nop()
...
/**
  ...
  * @retval None
  */
#define __HAL_RCC_LSEDRIVE_CONFIG(__LSEDRIVE__) sim_nop()
