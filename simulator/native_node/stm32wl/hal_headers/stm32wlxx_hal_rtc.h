...
#define __HAL_RTC_ALARM_EXTI_ENABLE_IT()            sim_nop()
#define __HAL_RTC_ALARM_EXTI_DISABLE_IT()           sim_nop()
#define __HAL_RTC_ALARM_EXTI_ENABLE_EVENT()         sim_nop()
#define __HAL_RTC_ALARM_EXTI_DISABLE_EVENT()        sim_nop()
