...
/* Simulator: redirect flash base to the flash_buf backing store */
#define FLASH_BASE              ((uint32_t)(uintptr_t)flash_buf)
...
/* Simulator: use compile-time constant instead of reading hardware register */
#define FLASH_SIZE              256000UL
